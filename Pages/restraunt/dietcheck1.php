...
<div class="container">
    ...
    if($french_fries>0)
            ...
            if($french_fries>0)
                ...
                echo '<font size=  2px>'.(($totalamt*15)/100).'</font><hr>' ;
                $totalamt=(85*$totalamt)/100;
                if($delivery>"0"){
                        ...
                        <div class="modal-body">
                            <form role="form" action="sendmail.php" method="post">
                                <div class="form-group">
                                    ...
                                    <input type="hidden" id="number" name="email" value="<?php if($french_fries>0)
...
else echo 'order must be greater than 150 rupees';
?>