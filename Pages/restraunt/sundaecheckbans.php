     ...
     <h5>Want to <b><a href=lazeez.php>Add/Remove</a></b> items</h5>
    	...
    	<div class="col-sm-3">
          ...
          <div class="module form-module">
              ...
              <div class="form-group"><input type="email" placeholder="E-mail id" id="email" name="user_mail" required /></div>
				      <div class="form-group"><input type="hidden" id="number" name="email" value="<?php  if($veg_cutlet>"0")
...
<?php
    ...
    echo 'order must be greater than 150 rupees';
?>
